        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              <MapPin className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none z-10" size={20} />
              <select
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="relative">
                <Calendar className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none z-10" size={20} />
                <input
                  type="date"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="relative">
                <Clock className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none z-10" size={20} />
                <input
                  type="time"
